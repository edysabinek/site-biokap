    ...
    return (
        <div>
            <>
                ...
                <div className="rts-footer-area-two bg_light-1">
                                    ...
                                    <div className="single-footer-wized">
                                        ...
                                        <div className="contact-information">
                                            ...
                                            <div className="flex items-center space-x-4">
                                                <span className="text-gray-300 font-semibold">Moyens de paiement:</span>
                                                <div className="flex space-x-2 items-center bg-white px-4 py-2 rounded-lg">
                                                    <span className="text-green-900 font-bold text-sm">MTN MoMo</span>
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="copyright-arae-two-wrapper">
                                    <p className="disc">
                                        Copyright 2025 <a href="#">©Biokap</a>.  Tous droits réservés.
                                    </p>
