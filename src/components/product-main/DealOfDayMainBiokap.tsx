...
const BlogGridMain: React.FC<BlogGridMainProps> = ({
    ...
    // tostify
    const compare = () => toast('Produit ajouté à la comparaison!');
    const addcart = () => toast('Produit ajouté au panier!');
    const wishList = () => toast('Produit ajouté à la wishlist !');
        ...
        <>
            ...
            <div className="body-content">
                ...
                <div className="cart-counter-action">
                    ...
                    >
                        <div className="btn-text">Ajouter au panier</div>
